            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-header-rose card-header-text">
                        <div class="card-text">
                            <h4 class="card-title">{{__('Edit')}} {{__('Gallery')}}</h4>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">

                        <form action="{{ route('admin.category.update') }}" method="POST" id="saveProduct"  enctype="multipart/form-data">
                            @csrf
...
<div class="col-md-6 form-group">
                                                ...
                                                <select class="form-control select2" style="width: 90%" name="parent_id" required="">
                                                    <option value="0" @if($data->parent_id == '0') selected="" @endif>Leave as Parent</option>
