        ...
        <div class="row mb-5">
            <div class="col">
                <div class="blog-slides owl-carousel owl-theme">
                    @php
                    $upcomingEventHomeArray = \App\Models\UpcomingEvent::where('status','!=','DELETED')->orderBy('sort_order')->orderBy('id','desc')->limit(6)->get();
                    @endphp
                    ...
                    <div class="blog-home-single">
                        <div class="blog-home-image">
                            ...
                            <div class="blog-home-post-date">
                                ...
                                <span>{{$value->event_date->format('M d, Y')}}</span>
                            </div>
                        </div>
                        <div class="blog-home-des-wrap">
                            ...
                            <div class="blog-home-des-right">
                                ...
                                <div class="blog-home-btn">
                                    <a href="{{route('web.upcoming_event.view',['slug'=>$value->url])}}"> Read More <i class="icofont-double-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
