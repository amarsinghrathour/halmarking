            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-header-rose card-header-text">
                        <div class="card-text">
                            <h4 class="card-title">{{__('Edit')}} {{__('Event')}}</h4>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">

                        <form action="{{ route('admin.upcoming_event.update') }}" method="POST" id="saveProduct"  enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-6 form-group">
                                    <label for="name">Event Date <span class="text-danger">*</span></label>
                                    <input type="date" name="event_date" value="{{$data->event_date->format('Y-m-d')}}" required="" class="form-control @error('event_date') is-invalid @enderror" autocomplete='off' placeholder="Enter Date" >
                                    @error('event_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="box-footer">
                                <div class="col-md-12" style="text-align: center">
                                    <a href="{{route('admin.upcoming_event')}}" class="btn btn-primary"><i class="fa fa-backward"></i> {{__('Back')}}</a>
