            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-header-rose card-header-text">
                        <div class="card-text">
                            <h4 class="card-title">{{__('Edit')}} {{__('Activity')}}</h4>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">

                        <form action="{{ route('admin.recent_activity.update') }}" method="POST" id="saveProduct"  enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-6 form-group">
                                    ...
                                    <input type="date" name="activity_date" value="{{$data->activity_date->format('Y-m-d')}}" required="" class="form-control @error('activity_date') is-invalid @enderror" autocomplete='off' placeholder="Enter Date" >
                                    @error('activity_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
