...
<section class="content">
    ...
    <div class="container-fluid">
        <form action="{{ route('admin.web_post.update') }}" method="POST" id="saveProduct"  enctype="multipart/form-data">
             <div class="row">
                 @csrf
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <select name="category" class="form-control select2" onchange="getSubCategory(this)">
                    ...
                    <select name="sub_category" disabled="" class="form-control select2" id="subCategory">
                        ...
                        <option value="{{$value->id}}" @if($data->sub_category_id == $value->id) selected='' @endif>{{$value->title}}</option>
                        @endforeach
                    </select>
                </div>
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea name="video_embed" class="form-control @error('video_embed') is-invalid @enderror" >{{$data->video_embed}}</textarea>
                                   @error('video_embed')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea name="audio_embed" class="form-control @error('audio_embed') is-invalid @enderror" >{{$data->audio_embed}}</textarea>
                                   @error('audio_embed')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <div class="card-body">
                    <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4 previewImage">
                                        @if(!empty($data->image))
                                        <img class="img img-responsive img-thumbnail" width="200px" src='{{asset($data->image)}}'>
                                        @endif
                                    </div>
                                </div>
                </div>
