            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.service.save') }}" method="POST" id="saveProduct"  enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="name">Icon(150 X 100) <span class="text-danger">*</span></label>
                                    <input type="file" name="icon" class="form-control @error('icon') is-invalid @enderror" onchange="previewImage(this);" required="">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="price_range" value="{{old('price_range')}}" class="form-control @error('price_range') is-invalid @enderror" autocomplete='off' placeholder="Enter Price Range" >
