            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-header-rose card-header-text">
                        <div class="card-text">
                            <h4 class="card-title">{{__('Edit')}} {{ $album->title }} {{__('Gallery')}} Image</h4>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">

                        <form action="{{ route('admin.web_album_image.update') }}" method="POST" id="saveProduct"  enctype="multipart/form-data">
                            @csrf
