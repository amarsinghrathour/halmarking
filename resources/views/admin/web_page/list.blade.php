      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <a href="{{ route('admin.web_page') }}" class="btn btn-sm btn-danger processing_btn m-1" style="float: right;">
                
                    <i class="fas fa-sync">&nbsp;</i>Refresh
                
            </a>
                <a href="{{ route('admin.web_page.add') }}" class="btn btn-sm btn-info m-1" style="float: right;">
                              ...
                              <div class="btn-group">
                                  <button type="button" class="btn btn-info dropdown-toggle dropdown-hover dropdown-icon" data-toggle="dropdown">
                                      ...
                                      <div class="dropdown-menu" role="menu">
                                          <a class="dropdown-item" onclick="location.href = '{{route('admin.web_page.edit',['id'=>$value->id])}}';" ><i class="fas fa-edit">&nbsp;</i>Edit</a>
