...
<!--wrapper-->
@php
            $dataArray = \App\Models\UpcomingEvent::where('status','ACTIVE')->orderBy('sort_order')->orderBy('id','desc')->get();
                        ...
                        <div class="container">
                            ...
                            <div class="team-box" style="height: 497px;">
                                <div class="team-photo">
                                    <div class="overlay"></div>
                                    <a href="{{route('web.upcoming_event.view',['slug'=>$value->url])}}">{{$value->title}}</a>
                                ...
                                <div class="team-info">
                                    <h3>{{$value->title}}</h3>
                                    <h4>{{$value->event_date->format('M d, Y')}}</h4>
