...
<section class="content">
    ...
    <div class="container-fluid">
             ...
             <form action="{{ route('admin.web_page.save') }}" method="POST" id="saveProduct"  enctype="multipart/form-data">
             <div class="row">
                 @csrf
            <div class="col-md-8">
                <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <select name="template" required="" style="width: 100%;" class="form-control select2 @error('template') is-invalid @enderror">
                            ...
                            <option value="detail">Detail (Default page to view content)</option>
                        </select>
                        @error('template')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
