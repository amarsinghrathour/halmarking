            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.web_album.update') }}" method="POST" id="saveProduct"  enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="name">Image(370x246) <span class="text-danger">*</span></label>
                                    <input type="file" name="image" class="form-control @error('image') is-invalid @enderror" onchange="previewImage(this);">
                                    <span>(Note: Allow Type: jpg,jpeg,png,bmp,tiff Max Size: 2mb, width: 370px, Height: 246px)</span>
                                    @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="box-footer">
                                <div class="col-md-12" style="text-align: center">
                                    <a href="{{route('admin.web_album')}}" class="btn btn-primary"><i class="fa fa-backward"></i> {{__('Back')}}</a>
