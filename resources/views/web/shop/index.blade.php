                ...
                <div class="container">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-capitalize">{{$pageDetail->title}}</li>
                        </ol>
                    </nav>
                    <h1 class="title_h1 font-weight-normal text-capitalize">{{$menu_detail->name}}</h1>
                </div>
            </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <ul class="category-products  wow fadeIn row" style="visibility: visible; animation-name: fadeIn;">
                                ...
                                @php
                $productList = \App\Models\Product::where('status','!=','DELETED')->orderBy('id','desc')->paginate(20);
                @endphp
                    ...
                    @endphp
                    @endforeach
                                <li class="col-lg-3 col-md-4 col-6 product wow fadeInLeft column4" data-wow-duration="1300ms" data-wow-delay="0.4s" style="visibility: visible; animation-duration: 1300ms; animation-delay: 0.4s; animation-name: fadeInLeft;">
                                    <div class="featured_content">
                                        <div class="featured_img_content">
                                            ...
                                            <div class="featured_btn vertical_middle">
                                                <span class="web-share text-uppercase background-btn sold_out_btn" onclick="webShare('{{ $productData->product_id }}','{{asset($productData->image)}}','{{ $productData->name }}',`{{$productData->description}}`,`{{json_encode($extraImages)}}`);">share</span>
                                            </div>
                                        </div>
